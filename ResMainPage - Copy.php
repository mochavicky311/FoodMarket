	...
	<div class="collapse navbar-collapse" id="navbarResponsive">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item">
				...
				<?php
					$userID = $_GET['userid'];
					echo "<form action='ResOrderPage.php' method='post'><input type='hidden' name='userid' value='".$_GET['userid']."'><input class='nav-link button-100' style='background: #3f3f3f' type='submit' name='nav-order' value='Orders'></form>";
				...
				?>
				<!--
				<form id='form1' action='ResOrderPage.php' method='post'><input type='hidden' id='userid' name='usrid' value="<?php //echo $_GET['userid']; ?>"></form>
				
				
				<a class="nav-link" href="#" onclick='navToOrderPage()'>Orders</a>-->
...
<div class="container-fluid">
	<div class="row jumbotron">
		...
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-2 padding" style="padding-top:4rem;">
			<?php
				echo "<form action='editResDesc.php' method='post'><input type='hidden' name='ResID' value='R001'>";
